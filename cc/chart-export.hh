...
template <typename RW> inline void JsonWriter_output(JsonWriterT<RW>& writer, const AntigenSerum& ag_sr)
{
...
template <typename RW> inline JsonWriterT<RW>& operator <<(JsonWriterT<RW>& writer, const Antigen& antigen)
{
...
template <typename RW> inline JsonWriterT<RW>& operator <<(JsonWriterT<RW>& writer, const Serum& serum)
{
